...
class AddFlightForm(Form):
    ...
    ground_time = FloatField('Pre/Post Ground')
    flight_time = FloatField('Flight Time')
    se_dual = FloatField('SE Dual')
    se_solo = FloatField('SE Solo')
    se_pic = FloatField('SE PIC')
    me_dual = FloatField('ME Dual')
    me_pic = FloatField('ME PIC')
    xc_pic_solo = FloatField('XC PIC Solo')
    xc_doal = FloatField('XC Dual')
    night_dual = FloatField('Night Dual')
    night_dual_xc = FloatField('Night Dual XC')
    night_pic_solo = FloatField('Night PIC Solo')
    se_complex = FloatField('SE Complex')
    instrument_hood = FloatField('Instrument Hood')
    instrument_actual = FloatField('Instrument Actual')
    ftd = FloatField('FTD')
    pcatd = FloatField('PCATD')
    ils = IntegerField('ILS')
    loc = IntegerField('LOC')
    vor = IntegerField('VOR')
    rnav_gps = IntegerField('RNAV/ GPS')
    ndb = IntegerField('NDB')
    landings_day = IntegerField('Landings Day')
    landings_night = IntegerField('Landings Night')
